...
## [0.6.0](https://github.com/klzbw/NAS-KTV/compare/v0.5.0...v0.6.0) (2026-08-30)


### Features

* add native tvOS/iOS client (Swift/SwiftUI) with unsigned IPA build workflow ([7dcb596](https://github.com/klzbw/NAS-KTV/commit/7dcb596e4c55f7df6384300ce3f91c7d8b17b3cf))
* add QR code scan-to-request feature (join ticket + H5 URL + QR display) ([79b8843](https://github.com/klzbw/NAS-KTV/commit/79b8843f267e4095dde63a81637936bd79bd6603))
* **admin-web,backend:** 去重管理分页支持 ([cd9528d](https://github.com/klzbw/NAS-KTV/commit/cd9528d6a15d3c2b8135b68e816814311edb7adb))
...
* **ai-parse:** AI 解析人工干预审核留痕 ([86dc078](https://github.com/klzbw/NAS-KTV/commit/86dc0787619201179ba86e1d062315f6bd609a1a))
* **ai-parse:** 歌曲管理页直接审核 AI 解析结果 ([66440ff](https://github.com/klzbw/NAS-KTV/commit/66440ffdedb97c08ed08e59176f1812153142273))
* **backend,admin-web,downloader:** 歌词检索与管理 ([c804a3c](https://github.com/klzbw/NAS-KTV/commit/c804a3cf244e06367c615eda0f5018db753e6401))
* **backend,admin-web:** MV 转码功能 + 人声分离推理设备配置 ([a238648](https://github.com/klzbw/NAS-KTV/commit/a238648fb2aca60aa38db9ee624656a33d60382b))
...
* **downloader,backend,tv-app,mobile-h5:** 逐字歌词（增强型 LRC）解析与播放端逐词高亮 ([ca8aa95](https://github.com/klzbw/NAS-KTV/commit/ca8aa95445064a4d25b0524bfe9ff4c272452eb5))
...
* **mobile-h5:** 遥控器增加麦克风音量控制入口 ([1f955b2](https://github.com/klzbw/NAS-KTV/commit/1f955b27084c5d748f2ae87beee5d488a9ed307d))
...
* **shared,backend:** 新增麦克风采集音量 WS 协议与中继 ([ffcd8d7](https://github.com/klzbw/NAS-KTV/commit/ffcd8d7b7f67bd6af49e9410049f4bf03cfbce5d))
* **tv-app:** 播放可视化动画美化 + 歌词偏移重置广播同步修复 ([7673045](https://github.com/klzbw/NAS-KTV/commit/76730451c275110e2bd726a6b745ba3c761d63c5))
* **tv-app:** 麦克风采集音量控制（Web Audio 软件增益 + WS 桥接） ([89d639b](https://github.com/klzbw/NAS-KTV/commit/89d639b556428fa059a40313483bacbbe23174a5))
...
* add authorization polling, scenePhase handling, prevent concurrent ticket refresh ([2cf9c15](https://github.com/klzbw/NAS-KTV/commit/2cf9c15c343aea208e5bce3b7c8d62a6837fee2c))
* add override to PlayerService init ([ffc2697](https://github.com/klzbw/NAS-KTV/commit/ffc2697df56d7b9bacb375e55fd0b025b73434c1))
* add UIApplicationSceneManifest to Info.plist, use safe audio session mode ([eabe811](https://github.com/klzbw/NAS-KTV/commit/eabe811208a295ab161792dff6f59c39a6706525))
...
* **backend:** 修复增强型 LRC 逐字时间戳正则捕获组缺失 ([b385341](https://github.com/klzbw/NAS-KTV/commit/b385341a306ee4858c5c8a96c240702352f8b478))
...
* call super.init() before setup in PlayerService ([bd174b5](https://github.com/klzbw/NAS-KTV/commit/bd174b54dc54233a5c33a2586c54452dfdb75a7e))
...
* connect WS regardless of auth, flexible authorized decode, load H5 early, add rotateCode API ([28a41cc](https://github.com/klzbw/NAS-KTV/commit/28a41cccca85581b8202e70e9e31dfd34148467c))
* correct PBXBuildFile/FileReference IDs in pbxproj ([dee7d90](https://github.com/klzbw/NAS-KTV/commit/dee7d906adbcc8064f0b26f816cb810db16a6c3c))
...
* lower deployment target to iOS/tvOS 16.0, use iOS16-compatible onChange API ([b966aa9](https://github.com/klzbw/NAS-KTV/commit/b966aa9cf1702d9743a0c90be8b74bfa9453685e))
...
* **mobile-h5:** 解除麦克风音量调节按钮对 supported 的门禁 ([94ba887](https://github.com/klzbw/NAS-KTV/commit/94ba887c82140885cb975bfc9a2bd5f27b0a3cc1))
* PlayerService inherit NSObject for KVO, remove tvOS-unavailable navBar mode ([cd9ab0b](https://github.com/klzbw/NAS-KTV/commit/cd9ab0b57e6ec4e50149d22703ca242d98b68248))
* remove ambiguous toolbar on tvOS16, fix remaining iOS17 onChange API ([7000a99](https://github.com/klzbw/NAS-KTV/commit/7000a9972f6f07574abe835e1cc87fe68836842b))
* remove manual Info.plist overwrite that broke CFBundleExecutable expansion ([cdeaef6](https://github.com/klzbw/NAS-KTV/commit/cdeaef6171fd43dda6d36d576078d1932c2537a4))
* replace JSONSerialization with type-safe decodePayload, fix AnyCodable encoding for arrays/dicts ([241c863](https://github.com/klzbw/NAS-KTV/commit/241c863b1aea5324684b63e2999628544d282b56))
...
* **tv-app,mobile-h5:** 歌词逐字高亮 rAF 锚点随播放状态同步 ([c94261a](https://github.com/klzbw/NAS-KTV/commit/c94261a1b5b63edc6c35b1be8b0fe0af46788841))
...
* tvOS compatibility - raise deployment to 17.0, fix textFieldStyle and tertiary color ([3745399](https://github.com/klzbw/NAS-KTV/commit/3745399ea96acb4b0579f378f109716c44d2e918))
...
* use iOS16-compatible single-parameter onChange for scenePhase ([2ceff9f](https://github.com/klzbw/NAS-KTV/commit/2ceff9fe8508c53ec9db1a2cc53b53ced9c28194))
...
* 修复 rotateCode 调用缺少 roomId 参数标签 ([e234664](https://github.com/klzbw/NAS-KTV/commit/e2346648f4f2472c987f5f751db9c282bcbdf9c6))
* 修复 tvOS 构建错误 - 移除不兼容 API (roundedBorder/controlSize/navigationBarTitleDisplayMode), 修复 Swift 并发问题 ([f4561f9](https://github.com/klzbw/NAS-KTV/commit/f4561f95d0f2da2d1f7ec577da8db3abd79edc4d))
